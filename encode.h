...
/* Typedef done to Structure to store information (variables) required for encoding secret file to source Image Info about output and intermediate data is also stored */
